...
class AlumnoT(models.Model) :
    ...
    fecha_nacimiento= models.DateField(max_length=50, verbose_name="Fecha nacimiento ", null=False,blank=False)
    fecha_ingreso= models.DateField(max_length=50, verbose_name="Fecha ingreso", null=False,blank=False)
